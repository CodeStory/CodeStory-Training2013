...
SCALASKEL_ALL=$(existe 'scalaskel-all')

echo -e "$LOGIN;[$EMAIL];[$MAILING];[$MOOD];[$POST_READY];[$TOUJOURS_OUI];[$ENONCE_1];[$ACK_ENONCE_1];[$SCALASKEL_1];[$SCALASKEL_2];[$SCALASKEL_7];[$SCALASKEL_8];[$SCALASKEL_11];[$SCALASKEL_19];[$SCALASKEL_21];[$SCALASKEL_28];[$SCALASKEL_42];[$SCALASKEL_97];[$SCALASKEL_ALL]"